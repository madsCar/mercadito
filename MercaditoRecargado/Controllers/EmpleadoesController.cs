...
namespace MercaditoRecargado.Controllers
{
    ...
    public class EmpleadoesController : Controller
    {
        ...
        public EmpleadoesController(ApplicationUserManager userManager, ApplicationRoleManager roleManager)
        {
        ...
        public async System.Threading.Tasks.Task<ActionResult> Create(EmpleadoUsuario model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                empleado.Persona.Ciudad = "XXXX";
                empleado.Persona.Telefono = "4777922360";
                empleado.Persona.Estado = "XXXX";
                empleado.Persona.Domicilio = "XXXX";
                empleado.Persona.CP = "XXXX";
                empleado.fechaIngreso = DateTime.Now;
                empleado.Estatus = 1;
                empleado.CodigoEmpleado = "11111";
