...
namespace mercadito.Controllers
{
    public class ProductosController : Controller
    {
        ...
        {
            ViewBag.CategoriaID = new SelectList(db.CategoriasProductos, "CategoriaID", "Descripcion");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ProductoID,nombre,CategoriaID,Estatus,Precio")] Producto producto)
        {
            ...
            ViewBag.CategoriaID = new SelectList(db.CategoriasProductos, "CategoriaID", "Descripcion", producto.CategoriaID);
            return View(producto);
        }
